...
## 🎯 단일 집중 목표
**"개발자 시선으로 0부터 — 동기부여형 + 이론·체험 병행."** 분류 암기가 아니라 **불편을 먼저 겪고 그 해결책으로 개념을 배우는** 과정. 1순위 = **ABAP 커리큘럼**(3트랙 — 구조 [09_CURRICULUM_LEDGER](09_CURRICULUM_LEDGER.md)·현황 [02_PROGRESS](02_PROGRESS.md)). UI5/Fiori·모듈·통합실습은 이후.
