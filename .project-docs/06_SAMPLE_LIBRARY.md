...
- 레슨 셸: A/B 폐기, **C안을 기준으로 종합 개선**(레일·학습여정·용어모음·헤더 그라데이션·T코드 미니페이지 모달·용어 hover/click·전체화면·**다크/글자크기/가독폭 localStorage**·**체험 슬롯(저장→검사→활성화, R4)**·**끝 미니퀴즈**). C 유력, D/E/F/G 참고. 최종 확정 후 본 셸/템플릿 반영.
