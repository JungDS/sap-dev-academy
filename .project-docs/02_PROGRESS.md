...
- **디자인 결정 현황**:
  ...
  - 레슨 셸: A/B 폐기(사용금지). **C안을 기준으로 종합 개선**(레일=E · 학습여정=F · 용어모음=G · 헤더 그라데이션(연한 민트) · T코드 미니페이지 모달 · 용어 hover/click · 전체화면(아이콘 토글) · **다크/글자크기(경계 비활성)/가독폭 localStorage** · **체험 슬롯(저장→검사→활성화, R4)** · **끝 미니퀴즈** · **본문 좌측 정렬로 여백 활용** · **모바일=하단 고정 여정 시트**). C가 유력 후보, D/E/F/G는 참고용. → 최종 확정 대기.
