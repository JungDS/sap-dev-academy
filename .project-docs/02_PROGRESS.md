...
| 런타임 셸(`assets/shell.js`/`shell.css`/`lesson.css`) | ✅ **v2-C 이식 Phase 1** — 앱바·설정(글자/다크/폭/전체화면)·좌측 레일(레슨/챕터/용어)·우측 여정(스크롤스파이·모바일 시트)·용어 hover/click·읽기진행·이전다음. 블루/그린+다크. (T코드 모달=Phase 2) [08](08_LESSON_SHELL_SPEC.md) |
