...
**기존 `C:\ABAP_DOCU_HTML\`(HTML, 758/8.16, 6,248파일) 대비**
...
1. **`C:\ABAP_DOCU_HTML\`** (공식 keyword doc HTML 덤프, **AS ABAP 758/8.16**, 6,105파일) — **1차 grep 대상**. 용어정의=`aben<term>_glosry.htm` · 예제=`*abexa*.htm` · ToC=`abap_docu_tree.htm` · 진입=`index.htm`. (추출 패턴: script블록 제거 → 태그 제거 → `class="h1"` 이후 본문.)
