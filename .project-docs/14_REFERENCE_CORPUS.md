...
**활용 규칙** — [11_KEYWORD_AUDIT](11_KEYWORD_AUDIT.md) 감사·용어 정의([04 R12](04_CONVENTIONS.md) glossary) 작업 시 **1차 grep 대상**으로 HTML 덤프와 병행. classic 사실은 `standard/md`, 경계 판정은 standard vs cloud 비교.
