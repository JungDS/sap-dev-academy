...
- CH17-L02:34 — `set_table_for_first_display` (도입 = CH17-L07)
- CH17-L04:48 — `set_table_for_first_display` (도입 = CH17-L07)
- CH17-L07:36 — `Global Class` (도입 = CH21-L01)
- CH18-L01:93 — `CONSTRUCTOR` (도입 = CH21-L03)
- CH18-L02:10 — `CONV` (도입 = CH18-L06)
- CH18-L02:9 — `CONSTRUCTOR` (도입 = CH21-L03)
- CH18-L03:13 — `CONSTRUCTOR` (도입 = CH21-L03)
- CH18-L06:14 — `CONSTRUCTOR` (도입 = CH21-L03)
- CH18-L10:90 — `CONSTRUCTOR` (도입 = CH21-L03)
...
- CH20-L07:128 — `Global Class` (도입 = CH21-L01)
...
- CH17-L03:19 — `Field Catalog` (도입 = CH17-L04)
- CH17-L04:90 — `Layout` (도입 = CH17-L05)
- CH17-L05:36 — `set_table_for_first_display` (도입 = CH17-L07)
- CH17-L06:19 — `set_table_for_first_display` (도입 = CH17-L07)
- CH17-L07:61 — `Stable Refresh` (도입 = CH17-L08)
- CH18-L05:87 — `CONV` (도입 = CH18-L06)
- CH18-L05:87 — `EXACT` (도입 = CH18-L06)
- CH18-L06:80 — `COND` (도입 = CH18-L07)
- CH18-L06:80 — `SWITCH` (도입 = CH18-L07)
- CH18-L07:73 — `REDUCE` (도입 = CH18-L08)
- CH18-L07:73 — `FILTER` (도입 = CH18-L08)
- CH19-L02:58 — `COALESCE` (도입 = CH19-L04)
- CH19-L03:80 — `CAST` (도입 = CH19-L04)
- CH19-L03:80 — `COALESCE` (도입 = CH19-L04)
- CH20-L01:4 — `CTE` (도입 = CH20-L02)
- CH20-L01:4 — `Subquery` (도입 = CH20-L03)
- CH20-L02:85 — `Subquery` (도입 = CH20-L03)
- CH20-L02:86 — `EXISTS` (도입 = CH20-L03)
- CH20-L04:67 — `Window expression` (도입 = CH20-L05)
