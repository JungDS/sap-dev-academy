...
| CH06-L04-S01 | CH06-L04 | decision-tree | Table Kind 선택 트리(자주 하는 일→STANDARD/SORTED/HASHED·유일키·정렬유지 분기). *구 CH06-L02-S02 rename — 결과문 게이팅 정리(sy-tabix·BINARY SEARCH 언급 제거, "빠르게 찾기 레슨" 예고만)* | ✅ |
