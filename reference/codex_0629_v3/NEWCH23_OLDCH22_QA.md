...
> 대상 산출물: `reference/codex_0629_v3/NEWCH23_OLDCH22_REWRITE.md`
> 작업 단위: CH22 1개 챕터
...
| 산출 파일 | `NEWCH23_OLDCH22_REWRITE.md`, `NEWCH23_OLDCH22_QA.md` |
...
| 파일 상태 | `NEWCH23_OLDCH22_REWRITE.md`, `NEWCH23_OLDCH22_QA.md` 두 파일만 신규 |
...
판정: `NEWCH23_OLDCH22_REWRITE.md`는 v3 품질 기준으로 사용 가능하다.
