...
> 대상 파일: `reference/codex_0629_v3/CH08_REWRITE.md`
> 작업 단위: CH08 모든 레슨
...
```text
git diff --check
rg -n "DATA\(|@DATA|@\w|VALUE #|NEW |\|.*\|" reference\codex_0629_v3\CH08_REWRITE.md
rg -n "\b(INSERT|UPDATE|DELETE|MODIFY|COMMIT|ROLLBACK|JOIN|GROUP BY|ORDER BY|DISTINCT)\b" reference\codex_0629_v3\CH08_REWRITE.md
rg -n "도입 불편|필요 학습수단|abapselect_join|abapselect_aggregate|abaptry" reference\codex_0629_v3\CH08_REWRITE.md
```
