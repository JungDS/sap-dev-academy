...
> 대상 파일: `reference/codex_0629_v3/CH14_REWRITE.md`
> 작업 단위: CH14 모든 레슨
...
```text
git diff --check
rg -n "DATA\(|@DATA|@\w|VALUE #|NEW |\+=|FINAL\(" reference\codex_0629_v3\CH14_REWRITE.md
rg -n "\|[^\n`]*\{[^\n`]*\}|\{[^\n`]*\}[^\n`]*\|" reference\codex_0629_v3\CH14_REWRITE.md
rg -n "\b(INSERT|UPDATE|DELETE|MODIFY|COMMIT|ROLLBACK|CREATE OBJECT|CL_GUI_ALV_GRID|LVC_T_FCAT)\b" reference\codex_0629_v3\CH14_REWRITE.md
rg -n "도입 불편|필요 학습수단|abapparameters\.htm|abapselect-options\.htm|abapselection-screen_definition\.htm|abapat_selection-screen_events\.htm|공식 문서 체크 힌트" reference\codex_0629_v3\CH14_REWRITE.md
```
