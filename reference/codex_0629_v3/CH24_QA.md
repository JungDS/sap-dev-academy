...
> 대상 산출물: `reference/codex_0629_v3/CH24_REWRITE.md`  
> 작업 단위: CH24 1개 챕터  
...
| 산출 파일 | `CH24_REWRITE.md`, `CH24_QA.md` |
...
| 파일 상태 | `CH24_REWRITE.md`, `CH24_QA.md` 두 파일만 신규 |
...
판정: `CH24_REWRITE.md`는 v3 품질 기준으로 사용 가능하다.
